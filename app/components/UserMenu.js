...
export default UserMenu = ({ currentUser, onAbout, onSignOut, onUserDemands, onUserReviews, onAdminDemands, onFlaggedDemands }) => (
  <View style={{
    flex: 1,
    ...
    <UserMenuItem onPress={onUserDemands} icon="place">
      Alterar endereço
    </UserMenuItem>
